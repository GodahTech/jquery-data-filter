 ...
 **/
!function(n){n.fn.filterData=function(t,i){return void 0===i?this.filter(function(){return void 0!==n(this).data(t)}):this.filter(function(){return n(this).data(t)===i})}}(jQuery);
